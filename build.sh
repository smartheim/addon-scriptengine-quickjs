...
git clone https://github.com/flier/rust-quickjs.git
PATH=$PATH:~/Programming/ohx/core/gen_certificate/target/libdbus/aarch64/bin CROSS_PREFIX=aarch64-linux-musl- cargo build --target aarch64-unknown-linux-musl

wget -q --show-progress https://bellard.org/quickjs/quickjs-2019-10-27.tar.xz -O quickjs.tar.xz
make -e CROSS_PREFIX=aarch64-linux-musl-
